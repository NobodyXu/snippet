#ifndef __nobodyxu_wheels_dynamic_connectivity_WeightedQuickUnionUF_v1_with_PathCompresson_HPP__
# define __nobodyxu_wheels_dynamic_connectivity_WeightedQuickUnionUF_v1_with_PathCompresson_HPP__
...
template <class Int>
struct WQU_UF_v1_with_PC: UF_impl1<Int, WQU_UF_v1_with_PC<Int>, ValueWithWeight<Int>> {
    using base = UF_impl1<Int, WQU_UF_v1_with_PC, ValueWithWeight<Int>>;
